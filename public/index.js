...
$('#ownTheme').on('click', function () {
  ...
  // $('.helloIcon').attr('src', 'images/icons/helloBlack.png');
  // $('.title').html('Tu propio tema');
})
...
$('#harry').on('click', function () {
  ...
  theme = 'harry';
  $(this).addClass('clicked');
  $('.helloIcon').attr('src', 'images/icons/hello.png');
